(function($) {
  var plotStations;
  plotStations = function(err, station_data, network_data) {
  ...
  return queue().defer(d3.json, "dist/data/station-nodes.json").defer(d3.json, "dist/data/station-network.json").await(plotStations);
})(jQuery, d3, _);
